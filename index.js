  ...
  async function getSign(surl,randsk){
    ...
    const res1 = await fetch('https://pan.baidu.com/s/1'+surl,
    {
      ...
      headers:{
        ...
        'Cookie':'BDUSS=XpnaUZkQjhJRmhmRUVlOEVCMkxRTjVOOEk2Y0EtUkJ4Vm1hQUxmUmNQcjFXRlpmRVFBQUFBJCQAAAAAAAAAAAEAAADFfSZ8sMG9v7XEyqbuo9DWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAPXLLl~1yy5fU; '
            +  'STOKEN=18640fed1753178f604ed39c13ff1ba0a4d9442dcb34499ed320ec1a23470473; BDCLND=' + randsk
      }
    })
...
const download = async request => {
  ...
  async function getDlink(fs_id,timestamp,sign,randsk,share_id,uk){
    ...
    const res3 = await fetch('https://pan.baidu.com/api/sharedownload?app_id=250528&channel=chunlei&clienttype=12&sign='+sign+'&timestamp='+timestamp+'&web=1',{
      ...
      headers:{
        'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.514.1919.810 Safari/537.36',
        'Cookie':'XpnaUZkQjhJRmhmRUVlOEVCMkxRTjVOOEk2Y0EtUkJ4Vm1hQUxmUmNQcjFXRlpmRVFBQUFBJCQAAAAAAAAAAAEAAADFfSZ8sMG9v7XEyqbuo9DWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAPXLLl~1yy5fU;'
            +  'STOKEN=18640fed1753178f604ed39c13ff1ba0a4d9442dcb34499ed320ec1a23470473; BDCLND=' + randsk
      },
      method:'POST'
      }
